    ...
    <div class="min-h-screen bg-gray-50 py-10">
        <div class="max-w-3xl mx-auto">
            <h2 class="text-3xl font-bold text-center text-gray-800 mb-8 flex items-center justify-center gap-3">
                📝 <span class="text-blue-600">Tạo bài thi mới</span>
            </h2>
            ...
            <form action="{{ route('admin.exams.store') }}" method="POST" class="bg-gradient-to-r from-white to-blue-50 p-8 rounded-3xl shadow-2xl border border-blue-100 space-y-6">
                @csrf
                ...
                <div class="flex flex-col sm:flex-row gap-4 mt-6 justify-center">
                    <button type="submit" class="flex items-center justify-center gap-2 bg-green-500 text-white px-6 py-3 rounded-xl hover:bg-green-600 transition shadow-lg font-medium text-lg">
                        💾 Lưu
                    </button>
